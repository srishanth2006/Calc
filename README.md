...
<head>
    ...
    <style>
        ...
        .button {
            ...
            margin-right: 550px;
            padding: 30px;
            background-color:rgb(200, 102, 47);
            color: rgb(255, 0, 0);
...
<body style="background-color: rgb(0, 0, 0);">
    <h1 align="center" style="color: aliceblue;">CALCULATOR</h1>
        <h3 align="center" style="color: aliceblue;">SRISHANTH J(212223240160)</h3>
        <div class="button">
            <center>
...
```
## OUTPUT:
![alt text](<Screenshot 2024-04-23 111040.png>)
![alt text](<Screenshot 2024-04-23 111053.png>)
## RESULT:
